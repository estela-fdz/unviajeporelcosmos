 ...
 */
define( 'AYS_QUIZ_NAME_VERSION', '6.2.1.4' );
define( 'AYS_QUIZ_VERSION', '6.2.1.4' );
            ...
            <div class="navigation-bar">
                <div id="navigation-container">
                    ...
                    <ul id="menu">
                        ...
                        <li class="modile-ddmenu-xs take_survay"><a class="ays-btn" href="https://docs.google.com/forms/d/1zP-gUqOtP9_U-fWQ7pJQN_EZeaOHTFy0Wadjh5SkrNk/viewform?edit_requested=true" target="_blank">Make a Suggestion</a></li>
                        ...
                        <li class="modile-ddmenu-sm">
                            ...
                            <ul class="ddmenu" data-expanded="false">
                                ...
                                <li><a class="ays-btn" href="https://quiz-plugin.com/wordpress-quiz-plugin-free-demo/" target="_blank">Demo</a></li>
                                <li><a class="ays-btn" href="https://wordpress.org/support/plugin/quiz-maker/" target="_blank">Free Support</a></li>
                                <li class="take_survay"><a class="ays-btn" href="https://docs.google.com/forms/d/1zP-gUqOtP9_U-fWQ7pJQN_EZeaOHTFy0Wadjh5SkrNk/viewform?edit_requested=true" target="_blank">Make a Suggestion</a></li>
                                <li><a class="ays-btn" href="https://wordpress.org/support/plugin/quiz-maker/" target="_blank">Contact us</a></li>
                            </ul>
                        </li>
                    </ul>
