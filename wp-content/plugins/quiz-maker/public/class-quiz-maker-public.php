    ...
    public function ays_generate_quiz($quiz){
        ...
        $additional_css = "
            <style>
                ...
                #ays-quiz-container-" . $quiz_id . ".ays_quiz_classic_light .ays-field.checked_answer_div input:checked+label,
                #ays-quiz-container-" . $quiz_id . ".ays_quiz_classic_dark .ays-field.checked_answer_div input:checked+label {
                    background-color: transparent;
                }";
        if (! $disable_hover_effect) {
            $additional_css .= "
