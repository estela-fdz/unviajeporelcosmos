        ...
        if($ishmar == 0 ){
            ...
            $content[] = '<div id="ays-quiz-dicount-month-main" class="notice notice-success is-dismissible ays_quiz_dicount_info">';
                $content[] = '<div id="ays-quiz-dicount-month" class="ays_quiz_dicount_month" style="display: flex;align-items: center;justify-content: space-between;">';
                    $content[] = '<a href="https://bit.ly/3gqkHDQ" target="_blank" class="ays-quiz-sale-banner-link"><img src="' . AYS_QUIZ_ADMIN_URL . '/images/great_bundle_logo.png" style="display: block; width: 60px;"></a>';

                    $content[] = '<div style="font-size:14px; padding:12px; width: 100%;">';

                        $content[] = '<strong style="font-weight: bold;">';
                            $content[] = __( "Limited Time <span style='color:red;'>50%</span> SALE on 5 Powerful Plugins", AYS_QUIZ_NAME );
                        $content[] = '</strong>';

                        $content[] = '<br>';

                        $content[] = '<strong style="font-size: 12px;font-weight: bold;">';
                                $content[] = __( "Great bundle offer for you! It consists of 5 different powerful plugins, each one allowing you to make your WordPress experience the best that could be.  Hurry! Ends on June 30. <a href='https://bit.ly/3gqkHDQ' target='_blank'>DON'T MISS OUT!</a>", AYS_QUIZ_NAME );
                        $content[] = '</strong>';
                    ...
                    $content[] = '<a href="https://bit.ly/3gqkHDQ" class="button button-primary ays-button" id="ays-button-top-buy-now" target="_blank" style="height: 32px; display: flex; align-items: center; font-weight: 500; " >' . __( 'Learn more', AYS_QUIZ_NAME ) . '</a>';
                $content[] = '</div>';
            $content[] = '</div>';
