        ...
        $(document).on('change', '.ays_quick_question_type', function (e) {
            ...
            switch (questionType) {
                ...
                case 'select':
                    ...
                    break; 
                case 'text':
                    var textHTML = '<input style="display:none;" class="ays-correct-answer ays_answer_unique_id" type="checkbox" name="ays_answer_radio['+ ays_answer_radio_id +']" value="1" checked/><textarea type="text" name="ays-correct-answer-value[]" class="ays-correct-answer-value" placeholder="'+ quizLangObj.answerText +'"></textarea>';
                    ...
                    break;
                case 'short_text':
                    var shortTextHTML = '<input style="display:none;" class="ays-correct-answer ays_answer_unique_id" type="checkbox" name="ays_answer_radio['+ ays_answer_radio_id +']" value="1" checked/><input type="text" name="ays-correct-answer-value[]" class="ays-correct-answer-value ays-text-question-type-value" placeholder="'+ quizLangObj.answerText +'" value=""/>';
                    ...
                    break;
                case 'number':
                    var numberHTML = '<input style="display:none;" class="ays-correct-answer ays_answer_unique_id" type="checkbox" name="ays_answer_radio['+ ays_answer_radio_id +']" value="1" checked/><input type="number" name="ays-correct-answer-value[]" class="ays-correct-answer-value ays-text-question-type-value" placeholder="'+ quizLangObj.answerText +'" value=""/>';
            ...
            if ( questionType != 'text' && questionType != 'short_text' && questionType != 'number' ) {
                if ( answersTable.hasClass('display_none') ) {
